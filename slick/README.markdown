...
prevArrow | string (html \| jQuery selector) \| object (DOM node \| jQuery object) | `<button type="button" class="slick-prev"></button>` | Allows you to select a node or customize the HTML for the "Previous" arrow.
nextArrow | string (html \| jQuery selector) \| object (DOM node \| jQuery object) | `<button type="button" class="slick-next"></button>` | Allows you to select a node or customize the HTML for the "Next" arrow.
